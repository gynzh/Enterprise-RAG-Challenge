...
We've added a **comprehensive visualization system** to help you understand the RAG pipeline interactively! This web-based interface lets you:

- 📄 **View PDFs inline** with zoom and navigation controls
- 📊 **Explore processing results** at each pipeline stage  
- 🔍 **Analyze JSON data structures** with tree visualization
- 💬 **Compare Q&A results** across different configurations
...
The visualization system automatically detects your processed data and provides an intuitive interface to explore:
- PDF parsing results and statistics
- Table serialization outputs  
- Vector database chunking details
- Question-answering results with citations

See `visualization/README.md` for detailed features and usage guide.
